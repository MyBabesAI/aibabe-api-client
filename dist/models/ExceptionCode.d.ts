...
export declare const ExceptionCode: {
    ...
    readonly AgeVerificationRequired: "age_verification_required";
    ...
    readonly GalleryFolderNotFound: "gallery_folder_not_found";
    readonly LiveChannelNotFound: "live_channel_not_found";
    readonly LiveChannelPaused: "live_channel_paused";
    readonly LiveRoundNotOpen: "live_round_not_open";
    readonly LiveConversionBelowMinimum: "live_conversion_below_minimum";
    readonly LiveWrongPhase: "live_wrong_phase";
    readonly LiveStaleRound: "live_stale_round";
    readonly LiveOptionNotFound: "live_option_not_found";
    ...
    readonly LiveCandidateExists: "live_candidate_exists";
    readonly LiveOpeningVotesBelowMinimum: "live_opening_votes_below_minimum";
    readonly LiveChatbotNotOwned: "live_chatbot_not_owned";
    readonly LiveSettingsInvalid: "live_settings_invalid";
};
