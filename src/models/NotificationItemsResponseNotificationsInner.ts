 ...
 */
export function instanceOfNotificationItemsResponseNotificationsInner(value: object): value is NotificationItemsResponseNotificationsInner {
...
export function NotificationItemsResponseNotificationsInnerFromJSON(json: any): NotificationItemsResponseNotificationsInner {
    return NotificationItemsResponseNotificationsInnerFromJSONTyped(json, false);
}

export function NotificationItemsResponseNotificationsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotificationItemsResponseNotificationsInner {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function NotificationItemsResponseNotificationsInnerToJSON(json: any): NotificationItemsResponseNotificationsInner {
      return NotificationItemsResponseNotificationsInnerToJSONTyped(json, false);
  }

  export function NotificationItemsResponseNotificationsInnerToJSONTyped(value?: NotificationItemsResponseNotificationsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
